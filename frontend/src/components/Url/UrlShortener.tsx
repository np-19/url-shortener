...
const UrlShortener = ({ onUrlCreated }: UrlShortenerProps) => {
  ...
  return (
    <div className="relative z-30 bg-white/80 backdrop-blur-xl rounded-[2.5rem] px-6 pt-4 pb-6 sm:px-8 sm:pt-5 sm:pb-8 lg:px-10 lg:pt-6 lg:pb-10 mx-auto overflow-visible animate-scaleIn shadow-[0_20px_60px_-15px_rgba(107,114,128,0.15)] border border-white">
